...
# ElasticExportAwinCOM plugin for plentymarkets 7

This is the ElasticExportAwinCOM plugin for plentymarkets 7 which extends the list of possible export formats.
